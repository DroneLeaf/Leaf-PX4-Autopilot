	...
	uORB::Subscription _vehicle_status_sub{ORB_ID(vehicle_status)};
        ...
        bool send() override
        {
                if (_vehicle_status_sub.updated()) {
                        ...
                        _failure_detector_status_sub.copy(&fd_status);
                        const uint16_t failure_detector_status =
                                (fd_status.fd_roll             ? (1u << 0) : 0u) |
                                (fd_status.fd_pitch            ? (1u << 1) : 0u) |
                                (fd_status.fd_alt              ? (1u << 2) : 0u) |
                                (fd_status.fd_ext              ? (1u << 3) : 0u) |
                                (fd_status.fd_arm_escs         ? (1u << 4) : 0u) |
                                (fd_status.fd_battery          ? (1u << 5) : 0u) |
                                (fd_status.fd_imbalanced_prop  ? (1u << 6) : 0u) |
                                (fd_status.fd_motor            ? (1u << 7) : 0u);
			...
			msg.failure_detector_status = failure_detector_status;			// Bitmask of detected failures
